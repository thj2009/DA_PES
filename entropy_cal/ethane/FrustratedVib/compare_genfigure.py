...
ax.hist(S50, density=True, bins=150, histtype='step', color='orange', label=r'Thres=50 $cm^{-1}$', hatch='\\\\\\\\\\\\')
ax.hist(S100, density=True, bins=150, histtype='step', color='g', label=r'Thres=100 $cm^{-1}$', hatch='//////')
ax.hist(S150, density=True, bins=150, histtype='step', color='r', label=r'Thres=150 $cm^{-1}$', hatch='xxxxxx')
#ax.hist(Stot, density=True, bins=150, histtype='step', color='b')
